  ...
  if (tipo === 'opened') {
    ...
    contenidoHtml = `
      <div style="font-family:Segoe UI,system-ui,sans-serif;max-width:560px;margin:0 auto;">
        <div style="background:#0F1F3D;padding:24px 28px;border-radius:10px 10px 0 0;">
          <span style="color:#C89B3C;font-size:20px;font-weight:800;letter-spacing:-0.5px;">AVO</span>
          <span style="color:#ffffff;font-size:14px;margin-left:10px;opacity:.7;">Sistema de Cotizaciones</span>
        </div>
